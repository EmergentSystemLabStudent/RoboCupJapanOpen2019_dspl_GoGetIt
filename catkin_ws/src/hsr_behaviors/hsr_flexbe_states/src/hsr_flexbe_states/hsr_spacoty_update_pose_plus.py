...
class hsr_SpaCoTyUpdateTidyPosePlus(EventState):
    '''
    ...
    def __init__(self):
        super(hsr_SpaCoTyUpdateTidyPosePlus,self).__init__(outcomes=['completed','failed'],input_keys=['object_name','tidy_pose_bef'],output_keys=['tidy_pose_aft'])
